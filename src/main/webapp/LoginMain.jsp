		...
		<form name="searchForm" action="LoginMain.jsp">
			<div class="formgrid">
				...
				<div class="gridItemCheckBerth">
					<label for="lodgingType">숙소 유형</label> <select class="form-select"
				...
				<button id="Search" type="submit"
					class="btn btn-primary gridItemBtn" name="search">검색</button>
			</div>
		</form>
									...
									<div id="panelsStayOpen-collapse<%=hotelInfo.getID()%>"
										...
										<div class="accordion-body">
											...
											<form id="bookingDateForm" action="bookingAction.jsp"
												...
												<div class="inputGrid">
													<div class="inputDate">
														<label for="checkInDate">체크인</label> <input type="hidden"
													...
													<div class="inputDate">
														<label for="checkOutDate">체크아웃</label> <input
												...
												<div class="gridItemPersonCnt" style="margin-bottom: 100px;">
													<label for="personCnt">인원</label> <select
												...
												<button type="submit" class="btn btn-primary"
													name="reserveBtn" data-bs-toggle="" data-bs-target="">예약하기</button>
											</form>
										</div>
									</div>
								</div>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary"
						onclick="location.href='./reservedCheck.jsp'">예약내역 확인하러
						가기</button>
